        ...
        if (strlen($response) > MAX_RESPONSE_SIZE) {
            ...
            curl_setopt_array($ch, [
                ...
                CURLOPT_POSTFIELDS => [
                    ...
                    'caption' => 'Response too fucking long, here’s the full shit as a file. Or View fucking Url Use 🥒 https://catseek.onrender.com/data/temp/' . basename($tempFileName)
                ],
                CURLOPT_HTTPHEADER => [
